...
- Linear Regression: model a relationship based on variables. Linear regression means the linear relationship of coefficients. So a polynomial might consider linear regression as well. The model is "linear" as long as the equation is just a simple weighted sum of its terms.
